import { defineComponent, reactive, computed, watch, openBlock, createElementBlock, normalizeStyle, unref, Fragment, renderList, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, resolveComponent, createBlock, withCtx, createElementVNode, createVNode, toDisplayString, createCommentVNode, withDirectives, vShow, useSlots, resolveDynamicComponent, h } from "vue";
import Taro, { useReady, createSelectorQuery, vibrateShort, getSystemInfoSync } from "@tarojs/taro";
...
const _hoisted_1$3 = /* @__PURE__ */ createElementVNode("text", { class: "fish-scroll__refresher-text" }, "\u52A0\u8F7D\u4E2D...", -1);
const _hoisted_2$2 = { class: "fish-scroll__refresher-text" };
const _hoisted_3$2 = { class: "fish-scroll__loadmore" };
const _hoisted_4$2 = /* @__PURE__ */ createElementVNode("text", { class: "fish-scroll__refresher-text" }, "\u52A0\u8F7D\u4E2D...", -1);
const _hoisted_5$1 = {
  key: 1,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_scroll_view, {
        ...
        default: withCtx(() => [
          createElementVNode("view", {
            ...
            state.refreshStatus === 2 ? (openBlock(), createBlock(_component_block, { key: 0 }, {
              ...
              default: withCtx(() => [
                ...
                createElementVNode("text", _hoisted_2$2, toDisplayString(state.refreshStatus === 1 ? "\u91CA\u653E\u5237\u65B0" : "\u4E0B\u62C9\u5237\u65B0"), 1)
              ]),
              _: 1
          ...
          withDirectives(createElementVNode("view", _hoisted_3$2, [
            createVNode(unref(LoadingIcon)),
            _hoisted_4$2
          ], 512), [
            [vShow, state.isMoreLoading]
          ]),
          !props.hasmore && !state.isMoreLoading ? (openBlock(), createElementBlock("view", _hoisted_5$1, toDisplayString(props.loadallText), 1)) : createCommentVNode("", true)
        ]),
        _: 3
            ...
            createElementVNode("view", _hoisted_2$1, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(props.tabList, (item, index) => {
                return openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode("view", _hoisted_4$1, toDisplayString(item.title), 1)
                ], 42, _hoisted_3$1);
              }), 128)),
              createElementVNode("view", {
...
export {
  _sfc_main$6 as Drag,
  _sfc_main$5 as DragX,
  _sfc_main$2 as Navbar,
  _sfc_main$4 as Scroll,
  _sfc_main as SwiperSlide,
  _sfc_main$3 as Tab,
  _sfc_main$1 as VirtualSwiper
};
