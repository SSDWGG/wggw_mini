...
export default defineAppConfig({
  ...
  subpackages: [
    ...
    {
      root: 'pages/tool',
      pages: ['menu/index','order-menu/index','order-menu/edit/index', 'bidding/index', 'bidding/detail/index', 'bidding/post/index', 'scoreboard/index', 'random/index', 'speedTest/index'],
    },
  ],
