...
export const useMusicStore = defineStore('musicStore', {
  state: (): IState => ({
    defaultBGM: {
      ...
      title: 'ありがとう···',
      singer: 'KOKIA',
      coverImgUrl: `${cdnHost}${ossFilePrePath}/GKNPEBAA-1678694972749test.jpeg`,
      src: `${cdnHost}${ossFilePrePath}/IEPOALOG-1679458147373thanks.mp3`
    },
    cxkMusicList: [
      {
        isplay:false,
        ...
        title: '你干嘛~哎呦~',
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
      ...
      },
      {
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src: `${cdnHost}${ossFilePrePath}/KPPHBLKN-1704879026226ij.mp3`
      },
      {
        isplay:false,
        epname: '奇鸡再现',
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src:  `${cdnHost}${ossFilePrePath}/CECPPDKF-1704878863927qjzx.mp3`
      },
      {
        isplay:false,
        epname: '鸡花瓷',
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src:  `${cdnHost}${ossFilePrePath}/NFJJPOLP-1704958512624jhc.mp3`
      },
      {
        isplay:false,
        epname: '曹鸡',
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src: `${cdnHost}${ossFilePrePath}/IBPDHKBN-1705023432828cj.mp3`
      },
      {
        isplay:false,
        epname: '本草鸡木',
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src: `${cdnHost}${ossFilePrePath}/PDEMMNJJ-1704958512624bcjm.mp3`
      },
      {
        isplay:false,
        epname: '仙剑鸡侠传',
        ...
        singer: 'kunkun',
        coverImgUrl: `${cdnHost}${ossFilePrePath}/HHHNOCBG-1702544256738kun.jpeg`,
        src: `${cdnHost}${ossFilePrePath}/OMFOJGMP-1704958512624xjjxz.mp3`
      },
      {
        isplay:false,
        epname: '!坤!',
