    ...
    cxkMusicList: [
      {
        ...
        title: '你干嘛~哎呦~',
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
      ...
      },
      {
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/KPPHBLKN-1704879026226ij.mp3'
      },
      {
        isplay:false,
        epname: '奇鸡再现',
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/CECPPDKF-1704878863927qjzx.mp3'
      },
      {
        isplay:false,
        epname: '鸡花瓷',
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/NFJJPOLP-1704958512624jhc.mp3'
      },
      {
        isplay:false,
        epname: '曹鸡',
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/IBPDHKBN-1705023432828cj.mp3'
      },
      {
        isplay:false,
        epname: '本草鸡木',
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/PDEMMNJJ-1704958512624bcjm.mp3'
      },
      {
        isplay:false,
        epname: '仙剑鸡侠传',
        ...
        singer: 'kunkun',
        coverImgUrl: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/HHHNOCBG-1702544256738kun.jpeg',
        src: 'https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggwSystem/OMFOJGMP-1704958512624xjjxz.mp3'
      },
      {
        isplay:false,
        epname: '!坤!',
