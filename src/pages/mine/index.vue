  ...
  <view :class="styles.myContainer">
    ...
    <view class="info">
      <view class="infoItem">
        ...
        <view class="content">
          <NutInput @blur="hanldeSetStoreAndStorage" v-model="data.info.username" placeholder="max len 10"
      ...
      <view class="infoItem">
        ...
        <view class="content">
          <NutInput @blur="hanldeSetStoreAndStorage" v-model="data.info.NoticeBarText" placeholder="max len 30"
            class="edit-NutInput" type="text" input-align="right" :border="false" />
        </view>
      </view>
      ...
      <view class="infoItem">
        ...
        <view class="content">
          <NutInput @blur="hanldeSetStoreAndStorage" v-model="data.info.waterMark" placeholder="max len 30"
            class="edit-NutInput" type="text" input-align="right" :border="false"
