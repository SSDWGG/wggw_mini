...
const handleShowPop = (e) => {
  ...
  if (!!pageData.canPlay) {
    // 显示svga
    pageData.url = `https://panshi-on.oss-cn-hangzhou.aliyuncs.com/yunxiaoding-mini/other/wggSVGA/liliSvga/${svgaUrlList[Math.floor(Math.random()* svgaUrlList.length)]}`
